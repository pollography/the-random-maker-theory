/**
 * @typedef {object} TopicInput
 * @property {string} slug
 * @property {string} name
 * @property {string} short
 * @property {string} image
 * @property {string[]} starterSlugs
 * @property {string[]} categoryAliases
 */

/** @param {TopicInput} input */
...
const FAMILY_BY_ALIAS = new Map(
	CORE_TOPICS.flatMap((topic) =>
		topic.categoryAliases.map((alias) => [alias, topic.slug])
	)
);
