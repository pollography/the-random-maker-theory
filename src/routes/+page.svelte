...
<style>
	...
	.topic-copy { padding: 13px 14px 15px; text-align: center; }
	...
	.topic-copy p { margin: 0; color: var(--color-text-dim); font-family: var(--font-mono); font-size: clamp(.62rem, .82vw, .72rem); line-height: 1.45; white-space: nowrap; }
