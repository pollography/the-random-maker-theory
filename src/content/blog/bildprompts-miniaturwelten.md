...
<div class="rf-block rf-callout" role="note" aria-label="Ergebnis">
	...
	<p>Die kleine Figur wirkt jetzt durch den direkten Vergleich am Schuh tatsächlich miniaturisiert und nicht wie eine jüngere Version.</p>
</div>
...
<div class="rf-block rf-callout" role="note" aria-label="Ergebnis">
	<span class="rf-label" aria-hidden="true">Ergebnis</span>
	<p>Die Arbeiter verteilen sich auf drei klar lesbare Aufgaben. Dadurch erzählt die Miniaturwelt gezielter als der erste Zufallstreffer.</p>
</div>
...
<div class="rf-block rf-callout" role="note" aria-label="Ergebnis">
	<span class="rf-label" aria-hidden="true">Ergebnis</span>
	<p>Die offene Box zeigt genau eine Figur und die vier festgelegten Studioobjekte. Zusätzliche Dekoration drängt sich nicht in die Geschichte.</p>
</div>
...
<div class="rf-block rf-callout" role="note" aria-label="Ergebnis">
	<span class="rf-label" aria-hidden="true">Ergebnis</span>
	<p>Die Kugel funktioniert weiterhin als fertiges Wintermotiv, ohne einen vom Modell erfundenen Spruch auf dem Sockel.</p>
</div>
...
<div class="rf-block rf-callout" role="note" aria-label="Ergebnis">
	<span class="rf-label" aria-hidden="true">Ergebnis</span>
	<p>Figur und sechs Teile sind übersichtlich getrennt. Die Grafik bleibt bewusst als Stilbeispiel bezeichnet und wird nicht als passgenaue Bastelvorlage ausgegeben.</p>
</div>
...
Hier nutze ich das bereits erzeugte Posenraster aus Teil 1 als echten Test. Ausgewählt wird Reihe 2, Spalte 3 – die hockende Pose unten rechts.
...
**Für dieses Beispiel eingesetzt:** Reihe 2, Spalte 3; die hockende Person unten rechts; Format 4:5.

![Ergebnis der Rasterauswahl: die hockende Pose als einzelnes Bild](/images/blog/ki-bildprompts/followups/extra-grid-selection-followup.webp)

<div class="rf-block rf-callout" role="note" aria-label="Ergebnis">
	<span class="rf-label" aria-hidden="true">Ergebnis</span>
	<p>Das Modell hat die richtige Zelle als Einzelmotiv übernommen. Pose, Kleidung und Identität bleiben erkennbar, während Raster und fünf ungewählte Varianten verschwunden sind.</p>
	<p>Für Thumbnails würde ich <code>/tinyWorkers</code> wählen. Für ein Geschenk ist <code>/snowGlobe</code> am klarsten. Für Outfitideen ist <code>/paperDoll</code> der interessanteste Startpunkt. Und <code>/miniMe</code> zeigt sehr schön, warum ein einziges Wort zwar kreativ, aber nicht eindeutig ist.</p>
	<p><a href="/blog/ultimate-bildprompts-part-2">Zur Übersicht mit allen 36 neuen Prompts</a> · <a href="/blog/bildprompts-spielzeug-sammlerstuecke">Zurück zu den Sammelfiguren</a> · <a href="/blog/bildprompts-comics-retro">Weiter zu Comics und Retro</a></p>
</div>
