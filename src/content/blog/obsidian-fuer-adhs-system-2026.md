---
title: "Obsidian ADHS: Mein System nach 6 Monaten"
slug: "obsidian-fuer-adhs-system-2026"
date: "2026-03-12"
description: "Obsidian fuer ADHS im Praxistest: 6 Monate, 4 Plugins, ein System das tatsaechlich haelt. Mein ehrlicher Erfahrungsbericht mit Template-Download."
tags: ["obsidian", "produktivitaet", "adhs", "tools", "workflow", "tutorial"]
...
**Morgens (5 Minuten):**
1. Obsidian oeffnen → Daily Note oeffnet automatisch
2. Top-3-Prioritaeten der Woche durchlesen (stehen schon da, aus Weekly Note)
3. Offene Tasks checken
4. Eins aussuchen und anfangen
...
- Task kommt rein? `- [ ]` in die aktuelle Notiz und weitermachen.
- Idee fuer ein Projekt? Neue Notiz, verlinken, fertig.

**Abends (3 Minuten):**
1. "End of Day Review" beantworten: "Was hat heute funktioniert?" und "Was war der groesste Blocker?"
2. Fertig.
...
- [Obsidian for ADHD: Productivity System](https://gilbertsanchez.com/posts/obsidian-and-adhd/) — Ausfuehrliches Setup-Guide fuer Obsidian mit ADHS
- [ADHD-friendly system — Obsidian Forum](https://forum.obsidian.md/t/adhd-friendly-system/12800) — Community-Diskussion zu ADHS-freundlichen Setups
- [Second Brain Tool: Obsidian — ADHD ftw!](https://adhdftw.com/second-brain-tool-obsidian/) — Obsidian als Second Brain fuer ADHS
- [Obsidian Pricing](https://obsidian.md/pricing) — Aktuelle Preise fuer Sync und Publish
- [Exekutive Dysfunktion bei ADHS — Belle Health](https://bellehealth.co/de/exekutive-dysfunktion-adhs/) — Erklaerung exekutiver Funktionsstoerungen
- [ADHS Produktivitaets-Strategien — Timeqube](https://timeqube.com/unkategorisiert/adhs-und-produktivitaets-hacks-praktische-strategien-fuer-erwachsene/?lang=de) — Praktische Strategien fuer Erwachsene mit ADHS
- [How to Build a Planning System in Obsidian for ADHD](https://www.addielamarr.com/how-to-build-a-planning-system-in-obsidian-that-actually-works-for-adhd-and-autistic-brains/) — Planungssystem fuer ADHS und autistische Gehirne

*Du willst wissen wie ich meinen Content-Workflow automatisiere? Check meinen [n8n Tutorial Deutsch](/blog/n8n-tutorial-deutsch-2026) — auch da spielt ADHS-gerechtes Arbeiten eine Rolle. Und wenn du grundsaetzlich besser mit KI-Tools arbeiten willst, schau mal in meinen Guide zu [Prompt Engineering lernen](/blog/prompt-engineering-lernen-2026).*
