...
/**
 * @typedef {{ width: number, height: number, format: 'png' | 'jpeg' | 'webp' }} ImageDimensions
 * @typedef {{ src: string, width: number }} ImageVariant
 * @typedef {ImageDimensions & { variants: ImageVariant[] }} ImageMetadata
 */
...
/** @param {Buffer} buffer @returns {ImageDimensions | null} */
...
/** @param {string} filePath @returns {ImageDimensions} */
...
/** @param {string} staticImagesRoot @param {string} filePath @returns {string} */
...
/** @param {string} staticImagesRoot @returns {Record<string, ImageMetadata>} */
export function buildImageMetadata(staticImagesRoot) {
	const root = resolve(staticImagesRoot);
	/** @type {Record<string, ImageDimensions>} */
	const baseEntries = {};
...
/**
 * @param {{ staticImagesRoot: string, outputPath: string }} options
 * @returns {Record<string, ImageMetadata>}
 */
...
/** @param {string} blogContentRoot @returns {Record<string, string[]>} */
...
/**
 * @param {{ blogContentRoot: string, outputPath: string }} options
