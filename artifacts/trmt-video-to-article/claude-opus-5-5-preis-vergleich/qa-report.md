...
| Release scope | PASS FOR DRAFT ONLY | One new draft article, one article test, one dossier, two images and generated image metadata are in scope. No production publication or main-branch merge is authorized. | Create and verify a Draft PR only. |
...
- Draft readiness: PASS, subject to a clean post-commit verification and successful Draft-PR checks.
