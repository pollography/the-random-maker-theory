...
- Dossier: `artifacts/trmt-video-to-article/gpt-6-astra-blender-3d-website/`
...
- Article scope: approved for one independent draft responding to active radar issue #26.
- Visual direction: approved existing canonical TRMT Crafted Editorial profile; article-specific output passes current image QA.
- Publication: pending; no merge or public deployment authority.
